...
public class condition {
	...
	public condition(CONSTANTS.var LH, op OP, CONSTANTS.var RH){
        ...
        //Test
        //**********************************************************************
        public void addConditionInfo(CONSTANTS.var LH, op OP, CONSTANTS.var RH){
            LHS = LH;
            Operator = OP;
            RHS = RH;
            time_once = true;
	 ...
	 */
	public boolean testCondition(item Parent, String objNam){
		/* Populate L and R */
		...
		boolean retCode = false;			//return code
                ...
                //Test Code
                //Tests to see if object
                //**************************************************************
                if(!compare){//Must be an object
                    if(objNam.equals(ifobject)){
                        retCode = true;
                    }
                }else{
                //**************************************************************
